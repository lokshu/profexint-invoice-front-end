...
import {Button, Form, FormItemProps, FormProps, Skeleton, Typography} from 'antd';
            ...
            <div className={styles.container} style={style}>
                ...
                <div className={styles.content}>
                    <div className={styles.input}>
                        ...
                        {loading && editingField === itemProps?.name && (
                    ...
                    {state === 'form' && (
                        <div className={styles.buttons}>
                            ...
                            <Button type="primary" {...saveButtonProps} loading={loading}>
                                Save
                            </Button>
                        </div>
                    )}
